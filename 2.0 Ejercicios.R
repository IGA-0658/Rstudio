...
#Enunciado: Define una función llamada saludo que imprima en la consola 
#el mensaje "Hola, bienvenido a R"
...
#Enunciado: Crea una función llamada calificar_edad que tome un parámetro numérico llamado 
#edad y muestre en la consola si la persona es "menor de edad" o "mayor de edad"
...
#Enunciado: Define una función llamada tabla_multiplicar que tome un parámetro numérico 
#n e imprima la tabla de multiplicar del 1 al 10 de ese número
...
#Enunciado: Crea una función llamada numeros_pares que tome un parámetro numérico 
